...
export const en = {
  ...
  settings: {
    ...
    reading: 'Reading',
    goal: 'Yearly goal',
    goalValue: (n: number | null) => (n ? `${n} books` : 'Not set'),
    loanLength: 'Default loan length',
    days: (n: number) => `${n} days`,
    library: 'Default library',
    notSet: 'Not set',
    reminders: 'Reminders',
    reminderTime: 'Reminder time',
    remind3d: '3-day reminder',
    remind1d: '1-day reminder',
    on: 'On',
    off: 'Off',
    display: 'Display',
    leadScript: 'Lead script',
    leadValue: { en: 'English first', si: 'Sinhala first' },
    specials: 'Include TV specials',
    data: 'Data',
    about: 'About',
    tmdb: 'Data from TMDB',
    ...
    goalClear: 'No goal',
    libraryHint: 'Pre-filled when you borrow a book',
    timeHint: 'Library reminders arrive at this time (Sri Lanka time).',
    hour: 'Hour',
    minute: 'Minute',
    earlier: (what: string) => `Earlier ${what}`,
    later: (what: string) => `Later ${what}`,
    yourYear: 'Your year',
  },
  year: {
    hand: 'so far this year',
    finished: (n: number) => `${n} ${n === 1 ? 'book' : 'books'}\nfinished`,
    goal: (n: number) => `GOAL · ${n} BOOKS`,
    noGoal: 'No yearly goal yet — set one in Settings.',
    shelf: (done: number, goal: number) => `${done} of ${goal} spines on the shelf`,
    languageSplit: 'Language split',
    segment: (language: string, n: number) => `${language} ${n}`,
    pagesRead: 'Pages read',
    episodes: 'Episodes watched',
    movies: 'Movies watched',
    hours: 'Hours watched',
    longest: (pages: number) => `Longest book · ${pages.toLocaleString('en')} pages`,
    fastest: (days: number) => `Fastest read · ${days} ${days === 1 ? 'day' : 'days'}`,
    rewatched: (n: number) => `Most rewatched · ${n} times`,
    none: '—',
    pickYear: 'Year',
  ...
  account: {
    ...
    exportCsv: 'Books (CSV)',
    exportHint: 'JSON or CSV',
    exporting: 'Preparing your export…',
    exportFailed: "Couldn't export. Check your connection and try again.",
    deleteTitle: 'Delete account',
    deleteRow: 'Delete account',
    deleteHint: "Deletes your library, loans, collections and notes. This can't be undone.",
    deleteBody: (books: number, movies: number, shows: number) =>
      `This removes your ${books} ${books === 1 ? 'book' : 'books'}, ${movies} ${movies === 1 ? 'movie' : 'movies'}, ${shows} ${shows === 1 ? 'show' : 'shows'}, all loans, collections and notes. It can't be undone.`,
    ...
    deleteOffline: 'You need to be online to delete your account.',
  },
  mediaOverflow: {
